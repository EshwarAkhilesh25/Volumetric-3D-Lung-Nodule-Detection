...
#     args = parser.parse_args()
    ...
    modelcheckpoint_path = "/kaggle/input/fold4-150/model_luna16_fold4_last150.pt"
    net = torch.jit.load(modelcheckpoint_path).to(device)
    print(f"Load model from {modelcheckpoint_path}")
...
#     3) build detector
    ...
    for epoch in range(min_epochs,max_epochs):
        ...
        torch.jit.save(detector.network, env_dict["model_path"][:-3] + "_last160.pt")
